...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?= base_url('guest/register'); ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="hidden" class="form-control" name="pasien_id" value="<?= $pasien_id ?>">
                        <input type="text" class="form-control" placeholder="<?= $session->nama ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
